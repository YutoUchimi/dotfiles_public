...
if [ $(echo "$ubuntu_version != 14.04" | bc) -eq 1 -a $(echo "$ubuntu_version != 16.04" | bc) -eq 1 ]; then
    ...
    wget https://developer.nvidia.com/compute/machine-learning/cudnn/secure/v7.0.4/prod/8.0_20171031/cudnn-8.0-linux-x64-v7

    file="cudnn-8.0-linux-x64-v7.tgz"
    if [ -e $file ]; then
        tar xfvz $file
        ...
        echo "\033[01;31m[$(basename $0)]   https://developer.nvidia.com/compute/machine-learning/cudnn/secure/v7.0.4/prod/8.0_20171031/cudnn-8.0-linux-x64-v7\033[00m\n"
        notyfy-send -i gnome-terminal -t 3000 -u normal \
